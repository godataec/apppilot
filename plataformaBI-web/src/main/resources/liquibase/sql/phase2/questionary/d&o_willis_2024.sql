INSERT INTO questionary (questionary_id,policy_id, questionary_name, description, created_at, questionary_status, source_file, total_number) VALUES ('9','3','FORMULARIO D&O WILLIS 2024','FORMULARIO D&O WILLIS 2024 TEMPLATE','','TRUE','FORMULARIOD&O2024WILIS.docx', 39);
...
(9006,'9','MULTIPLE','e','Desglose en % del volumen de las ventas realizadas en el último ejercicio. (Breakdown in % of the sales made during the last accounting period):',
...
(9007,'9','DES','2','','','',''),
(9008,'9','OPTIONAL','a','¿Es la Compañía? (Is the company?):',
...
(9012,'9','TABLE','d','Detalles de cualquier accionista de la sociedad con más del 5%. (Details of any shareholder with more than 5% paid up capital):',
       '','9007','willisDOpTHREEDtable'),
...
(9014,'9','OPTIONAL-NORMAL','f','¿Se cotizan las acciones públicamente? (Are shares publicly traded?)',
       '{"S1P2F1":{"Id":"S1P2F1","text":"En caso afirmativo, por favor confirmar la(s) Bolsa(s) de Valores en que se cotiza. (If yes, please specify the stock exchange(s) on which they are listed):","code":"willisDOpTHREEFYes"}}'
    ,'9007',''),
...
(9021,'9','OPTIONAL','b','¿Ha revelado la sociedad o alguna de sus subsidiarias públicamente que en el momento actual tiene en consideración cualquier absorción, fusión, adquisición y/o cambio de control durante el próximo año? (Has the company or any of its subsidiaries publicly announced any merger, acquisition or take-over within the next year?):',
...
(9023,'9','DES','4','EXPOSICIÓN EN LOS ESTADOS UNIDOS DE AMÉRICA (USA exposure)  ','','',''),
(9024,'9','OPTIONAL','1','¿Tiene la Compañía o cualquiera de sus Subsidiarias exposición en USA? Si la respuesta es SÍ, favor dar detalles de: SI/YES NO (Does the company or any of its subsidiaries have any exposure in the USA?; If yes, please give details of):',
       '{"S1P4Y":{"Id":"S1P4Y","text":"","code":"willisDOpFOURYes"},
...
(9028,'9','TABLE','c','Por favor, liste las filiales en USA (USA Subsidiaries):  ',
       '','9024','willisDOpFOURCtable'),

(9029,'9','DES','5','Confirmar si la Compañía o cualquier persona propuesta como Asegurado, se ha visto involucrada en: (Please confirm if the Company or anyone for whom insurance is intended  has been involved in the following):','','',''),
...
(9032,'9','OPTIONAL','c','"Representative Actions", "class actions" o demanda judicial derivativa. (Any representative actions, class actions or derivative suits):','{"S1P5C":{"Id":"S1P5C","text":"","code":"willisDOpFIVEc"}}','9029',''),
...
('9012','Nombre (Name)-Porcentaje de Acciones (% of shares)',''),
('9013','yes-no',''),
('9014','##yes-no',''),
('9017','yes-no',''),
('9020','yes-no',''),
...
('9022','yes-no',''),
('9024','yes-no',''),
('9028','Nombre (Name)-Porcentaje de Acciones (% of shares)',''),
('9030','yes-no',''),
('9031','yes-no',''),
('9032','yes-no',''),
('9034','yes-no',''),
