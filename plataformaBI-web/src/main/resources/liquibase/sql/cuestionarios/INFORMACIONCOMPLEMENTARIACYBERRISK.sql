...
VALUES 
  ('8', '2', 'INFORMACION COMPLETA SOLICITUD CYBER RISK', 'INFORMACION COMPLETA SOLICITUD CYBER RISK', '', 'TRUE', 'INFORMACIONCOMPLEMENTARIACYBERRISK.docx',4);
...
VALUES 
  ...
  (8004, '8', 'NORMAL', '4', 
    'Confirmar que todas las Entidades por asegurarse son 100% privadas y no controlados por ningún Gobierno o Estado.', 
    '', 
    '', 
