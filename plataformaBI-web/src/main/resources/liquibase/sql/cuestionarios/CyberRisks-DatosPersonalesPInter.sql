...
VALUES (6001, '6', 'NORMAL', '1', 'RAZÓN SOCIAL DEL ASEGURADO:', '{"S1P1":{"Id":"S1P1","text":"","code":"cyberRiskA"}}',
       ...
       (6003, '6', 'SUB', 'a', 'Por Región: ',
        '{"S1P2R1":{"Id":"S1P2R1","text":"Europa","code":"cyberRiskC"},"S1P2R2":{"Id":"S1P2R2","text":"EU / Canada","code":"cyberRiskD"},"S1P2R3":{"Id":"S1P2R3","text":"Resto del Mundo","code":"cyberRiskE"}}',
        '6002', ''),
       (6004, '6', 'DES', '3', 'CATEGORIAS DE DATOS PERSONALES RECOLECTADOS / PROCESADOS ', '', '', ''),
       ...
       (6008, '6', 'SUB', 'd', 'Otros, por favor especificar: ', '{"S1P4":{"Id":"S1P4","text":"","code":"cyberRiskO"}}',
        '6004', ''),
       (6009, '6', 'MULTIPLE', '4',
        'Se precisa el numero de registros, basados en los registros totales de operaciones de credito nuevas y stock',
        '{
        "S1P4R5": {
          "Id": "S1P4R5",
          "text": "TOTAL",
        ...
        "S1P4R4": {
          "Id": "S1P4R4",
          "text": "Persona Juridica - Créditos",
          "code": "cyberRiskS"
        },
        "S1P4R3": {
          "Id": "S1P4R3",
