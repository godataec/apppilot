...
VALUES 
  (7, 2, 'ECUADOR CUESTIONARIO RANSONWARE SUPPLEMENTAL',
   'ECUADOR CUESTIONARIO RANSONWARE SUPPLEMENTAL', '', 'TRUE', 'CuestionarioRansomwareSupplemental.xlsx', 47);
...
VALUES 
  (7001, 7, 'NORMAL', '', 'Nombre Completo del Solicitante', '', NULL, 'applicantName'),
  
  (7002, 7, 'SELECTOR-NORMAL', '1', 'Con respecto a los esfuerzos del Solicitante para mitigar la suplantación de identidad ("Phishing"), seleccione todas las que correspondan',
  ...
  (7004, 7, 'OPTIONAL', '2', '¿El Solicitante tiene un proceso documentado para responder a las campañas de phishing (ya sea que estén dirigidas específicamente al solicitante o no)?',
  ...
  (7006, 7, 'SELECTOR-NORMAL', '3', 'Con respecto a los esfuerzos del Solicitante para bloquear sitios web y/o correo electrónico potencialmente maliciosos, seleccione todo lo que corresponda:',
  ...
  (7010, 7, 'OPTIONAL', '5', 'Con respecto a la autenticación para contratistas y proveedores independientes que acceden remotamente a la red corporativa y cualquier servicio basado en la nube donde los datos confidenciales pueden residir (incluido el acceso VPN y el correo electrónico y CRM basados en la nube; juntos "acceso remoto a los recursos corporativos"), seleccione la descripción que mejor refleje la postura del solicitante:', 
       '{"S1P5OP1":{"Id":"S1P5OP1","text":"","code":"qFiveOpOne"}}', NULL, ''),
  
  (7011, 7, 'NORMAL', 'a', 'Comentarios adicional sobre autenticación para contratistas y proveedores independientes:', 
       '{"S1P5OP5":{"Id":"S1P5OP5","text":"","code":"qFiveOpFive"}}', 7010, ''),
  
  (7012, 7, 'OPTIONAL', '6', '¿La implementación de autenticación multifactor del solicitante también cumple los criterios de que el compromiso de un solo dispositivo sólo comprometerá un único autenticador?', 
  ...
  (7014, 7, 'SELECTOR-NORMAL', '7', 'Con respecto a la seguridad en los endpoints de estaciones de trabajo (computadoras y laptops), seleccione todas las que correspondan:',
  ...
  (7016, 7, 'OPTIONAL', '8', 'Con respecto a la supervisión de las herramientas de salida de seguridad, seleccione la descripción que mejor refleje las capacidades del solicitante:', 
  ...
  (7018, 7, 'OPTIONAL', '9', '¿Cuál es el tiempo medio del solicitante para evaluar y contener incidentes de seguridad de estaciones de trabajo?', 
  ...
  (7020, 7, 'OPTIONAL', '10', 'Con respecto a los controles de acceso para la estación de trabajo de cada usuario, seleccione la descripción que mejor refleje la postura del Solicitante:', 
  ...
  (7022, 7, 'SELECTOR-NORMAL', '11', 'Con respecto a la protección de credenciales privilegiadas, seleccione todas las que correspondan con la postura del Solicitante:',
  ...
  (7024, 7, 'DES', '12', 'Indique el uso de Microsoft Active Directory por parte del solicitante (en todos los dominios o "forests"):', '', NULL, ''),
  
  (7025, 7, 'NORMAL', 'a', 'El Solicitante no utiliza Microsoft Active Directory (indicar a la derecha)', 
       '{"S1P12OP1":{"Id":"S1P12OP1","text":"","code":"qTwelveOpOne"}}', 7024, ''),
  
  (7026, 7, 'NORMAL', 'b', 'Número de cuentas de usuario en el grupo Administradores de dominio (incluya cuentas de servicio , si las hay, en este total):', 
  ...
  (7029, 7, 'DES', '13', '¿Cuántos usuarios tienen cuentas privilegiadas persistentes para endpoints (servidores y estaciones de trabajo)?', '', NULL, ''),
  ...
  (7032, 7, 'SELECTOR-NORMAL', '14', 'Con respecto a la seguridad de los sistemas externos, seleccione todo lo que corresponda a la postura del Solicitante:',
  ...
  (7033, 7, 'OPTIONAL', '15', '¿Cuál es el tiempo objetivo del Solicitante para implementar parches "críticos" – de alta prioridad, (según lo determinen los estándares del solicitante para cuándo deben implementarse los parches)?', 
  ...
  (7035, 7, 'OPTIONAL', '16', '¿Cuál es el % de cumplimiento de los propios estándares del Solicitante al año para la implementación de parches críticos?', 
  ...
  (7037, 7, 'SELECTOR-NORMAL', '17', 'Con respecto a las capacidades de supervisión de la red del Solicitante, seleccione todas las que correspondan:',
  ...
  (7039, 7, 'OPTIONAL', '18', 'Con respecto a limitar el movimiento lateral, seleccione todo lo que se aplique a la postura del Solicitante:', 
  ...
  (7041, 7, 'OPTIONAL-NORMAL', '19', 'Introduzca la fecha del último ejercicio ransomware del Solicitante seleccionando la opción de Fecha, si no se ha llevado a cabo ninguno seleccione la opción correspondiente', 
       '{"S1P19OP1":{"Id":"S1P19OP1","text":"Fecha","code":"qNineteenOpOne"},
         "S1P19OP2":{"Id":"S1P19OP2","text":"No se ha realizado ningun ejercicio ransomware","code":"qNineteenOpTwo"}}', NULL, ''),
  
  (7042, 7, 'OPTIONAL', '20', '¿Tiene el solicitante un plan documentado para responder al ransomware de un proveedor/proveedor o cliente tercero?',
  ...
  (7044, 7, 'SELECTOR-NORMAL', '21', 'Con respecto a la verificación de la eficacia de los controles de seguridad, seleccione todo lo que se aplica al Solicitante:',
  ...
  (7046, 7, 'SELECTOR-NORMAL', '22', 'Con respecto a las capacidades de recuperación ante desastres, seleccione todas las que se aplican al Solicitante:',
  ...
  (7047, 7, 'OPTIONAL', '23', '¿Cuál es el tiempo de recuperación objetivo (RTO) del Solicitante para los sistemas críticos?', 
       '{"S1P23OP1":{"Id":"S1P23OP1","text":"","code":"qTwentyThreeOpOne"}}', NULL, ''),
  
  (7048, 7, 'SELECTOR-NORMAL', '24', 'Con respecto a las capacidades de las copias de seguridad, seleccione todas las que se aplican al Solicitante:',
       '{"S1P24OP1":{"Id":"S1P24OP1","text":"La estrategia de copia de seguridad del Solicitante incluye copias de seguridad sin conexión (se pueden almacenar en el sitio).","code":"qTwentyfourOpOne"},
         ...
         "S1P24OP3":{"Id":"S1P24OP3","text":"Solo se puede acceder a las copias de seguridad del solicitante a través de un mecanismo de autenticación fuera de nuestro Active Directory corporativo.","code":"qTwentyfourOpThree"}}', NULL, ''),
  ...
  (7050, 7, 'OPTIONAL', '25', '¿El Solicitante cuenta con alguna política que todos los dispositivos portátiles utilizan cifrado de disco completo?', 
