INSERT INTO QUESTIONNAIRE (IDQUESTIONNAIRE,IDINSURANCE, NAMEQUESTIONNAIRE, DESCRIPTION, CREATEDAT, STATUS, SOURCEFILE, TOTALQUESTION) VALUES ('4','1','ANEXO 3 CUESTIONARIO PI','ANEXO 3 CUESTIONARIO PI','','TRUE','ANEXO3-FORMULARIOPI.docx', 27);
...
(4020,'4','SELECTOR-NORMAL','b','Por favor seleccione el método que se utiliza para verificar la identidad de los usuarios que realizan transacciones vía Internet / (Please select the method used to verify the identity of the users transacting via the Internet):','{"S1P12B":{"Id":"S1P12B","text":"","code":"Anexo3pis1p12b"}}','4001',''),
...
(4025,'4','OPTIONAL-NORMAL','g','¿Utiliza algún programa para la prevención de virus? / Do you use any anti-virus software?','{"S1P12G":{"Id":"S1P12G","text":"Si la respuesta es SÍ, ¿se actualiza este regularmente? / If yes, is it upgraded on a regular basis?","code":"Anexo3pis1p12g"}}','4001',''),
