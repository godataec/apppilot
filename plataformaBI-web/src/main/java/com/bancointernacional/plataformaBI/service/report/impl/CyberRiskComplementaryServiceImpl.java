...
import com.bancointernacional.plataformaBI.service.report.CyberRiskComplementaryService;
...
public class CyberRiskComplementaryServiceImpl implements CyberRiskComplementaryService {
    ...
    @Override
    public CyberRiskComplementaryInfoForm fullFillQuestionerData(String policyQuestionaryId) {
